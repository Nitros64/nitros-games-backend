...
grep -q '^OAUTH2_RESOURCE_ID=nitros-games-api$' "$success_directory/.env"
grep -q '^OAUTH2_ACCESS_SCOPE=nitros-games-api/access$' "$success_directory/.env"
grep -q '^OAUTH2_ADMIN_SCOPE=nitros-games-api/admin$' "$success_directory/.env"
grep -q '^OAUTH2_ALLOWED_CLIENT_IDS=nitros-games-web,nitros-games-cli,nitros-games-reader-cli$' "$success_directory/.env"
